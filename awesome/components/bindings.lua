...
self.keys = gears.table.join(
  ...
  awful.key({modkey}, "w", function() conf.menu:show() end, {description = "show main menu", group = "awesome"} ),
  ...
  awful.key({modkey}, "Return", function() awful.spawn(conf.terminal) end, {description = "open a terminal", group = "launcher"} ),
  ...
  awful.key({modkey}, "p", function() awful.spawn(conf.launcher, false) end, {description = "open launcher", group = "launcher"} ),
